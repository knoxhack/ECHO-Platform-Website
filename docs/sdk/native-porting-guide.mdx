...
See [Native Mod Author Guide](/docs/sdk/native-mod-author-guide), [Native API Reference](/docs/sdk/native-api-reference), and [Native Example Addon Walkthrough](/docs/sdk/native-example-addon-walkthrough) for the canonical RC1 workflow.
