...
Hytale runtime support is intentionally out of scope for the current content graph schemas. A Hytale adapter/codegen contract and separate runtime validation gate must exist before Hytale evidence can be treated as playable support.
