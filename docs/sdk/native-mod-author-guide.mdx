...
3. Pick a [template](/docs/sdk/native-templates) matching your addon type.
...
See [Release Packaging Guide](/docs/sdk/native-release-packaging-guide) for artifact naming, checksums, and metadata requirements.
