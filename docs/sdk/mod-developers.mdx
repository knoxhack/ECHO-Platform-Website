...
Use [API_STABILITY.md](/docs/sdk/api-stability) as the source of truth for Stable/Beta/Experimental/Internal API surfaces. Use [OPTIONAL_INTEGRATIONS.md](/docs/sdk/optional-integrations) for safe no-op integration patterns.
