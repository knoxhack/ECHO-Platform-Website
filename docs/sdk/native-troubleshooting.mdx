...
- Open an issue using the [Bug Report](https://github.com/knoxhack/ECHO-SDK/blob/main/.github/ISSUE_TEMPLATE/bug_report.md) or [Addon Author Support](https://github.com/knoxhack/ECHO-SDK/blob/main/.github/ISSUE_TEMPLATE/addon_author_support.md) template.
